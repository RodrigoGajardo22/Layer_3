...
import ar.unrn.tp3.modelo.RepositorioConcurso;
...
public class UI {
	...
	private RepositorioConcurso repositorio;

	public UI(RepositorioConcurso repositorio) {
	...
	private void todosLosConcursos() {
		...
		for (Concurso concurso : repositorio.todosLosConcursos()) {
	...
	private void saveInscription() {
		if (validations()) {
			...
			repositorio.cargarParticipante(nombre, apellido, tel, dni, email, concurso.ID());
